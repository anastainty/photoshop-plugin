...
resource 'PiPL' ( 16000, "Invert", purgeable )
{
	{
		Kind { Filter },
		Name { "Klitsunova " "Inverse" },
		Category { "Own Plugins" },
...
resource 'aete' (16000, "Invert dictionary", purgeable)
{
	1, 0, english, roman,									/* aete version and language specifiers */
	{
		...
		{													/* structure for filters */
			...
			{												/* parameters here, if any */
				...
				"invert amount",							/* optional description */
				...
				"invert disposition",						// optional description
